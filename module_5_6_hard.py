...
# создание метода "verification_password", который при регистрации будет проверять пароль на надежность,
...
def verification_password(password):
    ...
    for what, message in ((digits, "цифру"), (upper_letters, "заглавную букву"), (lower_letters, "строчную букву")):
    ...
    if recom_password:
        print("Пароль не надежный. Рекомендации:", ", ", ", ".join(recom_password))
